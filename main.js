...
Object.defineProperty(exports, 'NumberField', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_NumberField).default;
  }
});
...
Object.defineProperty(exports, 'FieldConnect', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_FieldConnect).default;
  }
});

var _FieldsRestyle = __webpack_require__(59);

Object.defineProperty(exports, 'fieldsRestyle', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_FieldsRestyle).default;
  }
});

var _FormEventsListener = __webpack_require__(65);

Object.defineProperty(exports, 'FormEventsListener', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_FormEventsListener).default;
  }
});
...
var FormEventsListener = function () {
    function FormEventsListener() {
        _classCallCheck(this, FormEventsListener);
    ...
    _createClass(FormEventsListener, [{
        key: 'registerEvent',
        ...
        value: function registerEventListener(name, method) {
            if (this.eventsListeners[name] && Array.isArray(this.eventsListeners[name]) && typeof method === 'function') {
                this.eventsListeners[name].push(method);
            }
        }
    }, {
        key: 'unregisterEvent',
        value: function unregisterEvent(name) {
        ...
        value: function unregisterEventListener(name, handler) {
            if (this.eventsListeners[name] && Array.isArray(this.eventsListeners[name])) {
                var index = this.eventsListeners[name].indexOf(handler);
                if (index > -1) this.eventsListeners[name].splice(index, 1);
            }
        }
    }, {
        key: 'callEvent',
        value: function callEvent(name, data) {
            var responseFromEventsListeners = [];
            if (this.eventsListeners[name] && Array.isArray(this.eventsListeners[name])) {
                this.eventsListeners[name].forEach(function (eventListener) {
                    var response = eventListener(data);
    ...
    return FormEventsListener;
}();

exports.default = FormEventsListener;
