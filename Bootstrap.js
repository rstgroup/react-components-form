...
var extendStyles = function extendStyles(styles, _ref) {
    var className = _ref.className,
        wrapperClassName = _ref.wrapperClassName,
        itemWrapperClassName = _ref.itemWrapperClassName,
        _ref$addButton = _ref.addButton,
        addButton = _ref$addButton === undefined ? {} : _ref$addButton,
        _ref$removeButton = _ref.removeButton,
        removeButton = _ref$removeButton === undefined ? {} : _ref$removeButton,
        _ref$errorStyles = _ref.errorStyles,
        errorStyles = _ref$errorStyles === undefined ? {} : _ref$errorStyles,
        restProps = _objectWithoutProperties(_ref, ['className', 'wrapperClassName', 'itemWrapperClassName', 'addButton', 'removeButton', 'errorStyles']);

    return _extends({
        className: (0, _classnames2.default)((0, _helpers.get)(styles, 'className'), className),
        wrapperClassName: (0, _classnames2.default)((0, _helpers.get)(styles, 'wrapperClassName'), wrapperClassName),
        itemWrapperClassName: (0, _classnames2.default)((0, _helpers.get)(styles, 'itemWrapperClassName'), itemWrapperClassName),
        addButton: _extends({}, addButton, {
            className: (0, _classnames2.default)((0, _helpers.get)(styles, 'addButton.className'), addButton.className)
        }),
        removeButton: _extends({}, removeButton, {
            className: (0, _classnames2.default)((0, _helpers.get)(styles, 'removeButton.className'), removeButton.className)
        }),
        errorStyles: _extends({}, errorStyles, {
            className: (0, _classnames2.default)((0, _helpers.get)(styles, 'errorStyles.className'), errorStyles.className),
            itemClassName: (0, _classnames2.default)((0, _helpers.get)(styles, 'errorStyles.itemClassName'), errorStyles.itemClassName),
            fieldClassName: (0, _classnames2.default)((0, _helpers.get)(styles, 'errorStyles.fieldClassName'), errorStyles.fieldClassName)
        })
    }, restProps);
};

var fieldsRestyle = function fieldsRestyle(styles, fields) {
    var restyledFields = {};
    Object.keys(fields).forEach(function (fieldName) {
        var Field = fields[fieldName];
        restyledFields[fieldName] = function (props) {
            return _react2.default.createElement(Field, extendStyles(styles[fieldName], props));
        };
    });
    return restyledFields;
};

exports.default = fieldsRestyle;
...
var Form = function (_React$Component) {
    ...
    function Form(props) {
        ...
        _this.state = {
            schema: props.schema || {},
            model: props.model || _this.getDefaultModelValue(props.schema),
            errors: {},
            validateOnChange: props.validateOnChange
        };

        _this.eventsListener = props.eventsListener;
        _this.setModel = _this.setModel.bind(_this);
        _this.getModel = _this.getModel.bind(_this);
        _this.getSchema = _this.getSchema.bind(_this);
        _this.submitForm = _this.submitForm.bind(_this);
        _this.runSubmit = _this.runSubmit.bind(_this);
        _this.getErrors = _this.getErrors.bind(_this);
        _this.getPath = _this.getPath.bind(_this);
    ...
    _createClass(Form, [{
        ...
        value: function registerEvents() {
            ...
            if (this.eventsListener) {
                this.eventsListener.registerEventListener('submit', function () {
                    return _this2.submitForm();
                });
                this.eventsListener.registerEventListener('validate', function (schema) {
                    return _this2.validateModel(_this2.state.model, schema || _this2.state.schema);
                });
                this.eventsListener.registerEventListener('reset', function (model) {
                    var newModel = model || _this2.getDefaultModelValue(_this2.state.schema);
                    _this2.setState({ model: newModel });
                });
            }
        }
    }, {
        key: 'getDefaultModelValue',
        value: function getDefaultModelValue(schema) {
            if (schema && typeof schema.getDefaultValues === 'function') return schema.getDefaultValues();
            return {};
        }
    }, {
        key: 'setModel',
        value: function setModel(name, value, callback) {
        ...
        key: 'validateModel',
        value: function validateModel(model, schema) {
            var _this3 = this;

            var customValidation = this.props.customValidation;
            ...
            if (errors instanceof Promise) {
                return new Promise(function (resolve) {
                    errors.then(function (errorsFromPromise) {
                        _this3.setState({ errors: errorsFromPromise });
        ...
        value: function submitForm(event) {
            ...
            var model = Object.assign({}, this.state.model);
            var errors = this.validateModel(model, this.state.schema);
        ...
        key: 'runSubmit',
        value: function runSubmit(errors, model) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'form',
                { onSubmit: this.submitForm, id: id, className: className },
                children
            );
        }
    }]);
...
var ListField = exports.ListField = function (_React$Component) {
    _inherits(ListField, _React$Component);

    _createClass(ListField, null, [{
        key: 'generateItemId',
        value: function generateItemId() {
            return Math.random().toString(36).substring(7);
        }
    }]);

    function ListField(props, _ref) {
        var getSchema = _ref.getSchema;

        _classCallCheck(this, ListField);

        var _this = _possibleConstructorReturn(this, (ListField.__proto__ || Object.getPrototypeOf(ListField)).call(this, props));

        _this.state = {
            schema: getSchema(props.name),
            model: _this.getModelFromProps(props),
            errors: {}
        };
        _this.setModel = _this.setModel.bind(_this);
        _this.getModel = _this.getModel.bind(_this);
        _this.getList = _this.getList.bind(_this);
        _this.addListElement = _this.addListElement.bind(_this);
        _this.removeListElement = _this.removeListElement.bind(_this);
        _this.getSchema = _this.getSchema.bind(_this);
        _this.getErrors = _this.getErrors.bind(_this);
        return _this;
    }
    ...
    _createClass(ListField, [{
        key: 'getModelFromProps',
        value: function getModelFromProps(props) {
            if (props.value) {
        ...
        value: function setModel(name, value, callback) {
            ...
            var model = Array.from(this.state.model);
            model[parseInt(key)].value = value;
            this.setState({ model: model }, callback);
            this.props.onChange(model.map(function (item) {
                return item.value;
            }));
        }
    }, {
        ...
        value: function removeListElement(key) {
            var model = Array.from(this.state.model);
            model.splice(key, 1);
            this.setState({ model: model });
            this.props.onChange(model.map(function (item) {
        ...
        key: 'getList',
        value: function getList(children) {
            var _this2 = this;

            var _props = this.props,
                name = _props.name,
                _props$removeButton = _props.removeButton;
            _props$removeButton = _props$removeButton === undefined ? {} : _props$removeButton;
            var wrapperClassName = _props$removeButton.wrapperClassName,
                className = _props$removeButton.className,
                value = _props$removeButton.value,
                hideRemoveButton = _props.hideRemoveButton,
                itemWrapperClassName = _props.itemWrapperClassName;


            return this.state.model.map(function (item, key) {
                ...
                return _react2.default.createElement(
                    'div',
                    { key: item.id, className: itemWrapperClassName },
                    child,
                    !hideRemoveButton && _react2.default.createElement(
                        'div',
                        { className: wrapperClassName },
                        _react2.default.createElement(
                            'span',
                            {
                                onClick: function onClick() {
                                    return _this2.removeListElement(key);
                                },
                                className: className
                            },
                            value || 'Remove'
        ...
        value: function render() {
            var _props2 = this.props,
                ...
                wrapperClassName = _props2.wrapperClassName,
                label = _props2.label,
                _props2$addButton = _props2.addButton,
                addButton = _props2$addButton === undefined ? {} : _props2$addButton,
                hideAddButton = _props2.hideAddButton,
                _props2$fieldAttribut = _props2.fieldAttributes,
                fieldAttributes = _props2$fieldAttribut === undefined ? {} : _props2$fieldAttribut;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    _extends({ className: className }, fieldAttributes),
                    this.getList(children)
                ),
                !hideAddButton && _react2.default.createElement(
                    'span',
                    {
...
ListField.propTypes = {
    className: _react.PropTypes.string,
    wrapperClassName: _react.PropTypes.string,
    itemWrapperClassName: _react.PropTypes.string,
    label: _react.PropTypes.string,
    addButton: _react.PropTypes.shape({
        className: _react.PropTypes.string,
        value: _react.PropTypes.node
    }),
    removeButton: _react.PropTypes.shape({
        wrapperClassName: _react.PropTypes.string,
        className: _react.PropTypes.string,
        value: _react.PropTypes.node
    }),
    hideAddButton: _react.PropTypes.bool,
    hideRemoveButton: _react.PropTypes.bool,
    onChange: _react.PropTypes.func.isRequired,
    name: _react.PropTypes.string,
    value: _react.PropTypes.any,
    fieldAttributes: _react.PropTypes.shape({})
...
exports.default = (0, _FieldConnect2.default)(ListField);
...
var ObjectField = exports.ObjectField = function (_React$Component) {
    ...
    _createClass(ObjectField, [{
        ...
        value: function componentWillMount() {
            ...
            var schema = getSchema(this.props.name).type;
        ...
        value: function getErrors(name) {
            ...
            var errors = getErrors(this.props.name);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                _extends({ className: wrapperClassName }, fieldAttributes),
                children
            );
        }
    }]);
...
exports.default = (0, _FieldConnect2.default)(ObjectField);
...
exports.ListField = exports.ObjectField = exports.CheckboxField = exports.SelectField = exports.SubmitField = exports.NumberField = exports.TextareaField = exports.DateField = exports.TextField = exports.Form = undefined;
...
var _FieldsRestyle = __webpack_require__(59);

var _FieldsRestyle2 = _interopRequireDefault(_FieldsRestyle);
...
var _ObjectField = __webpack_require__(62);

var _ObjectField2 = _interopRequireDefault(_ObjectField);

var _ListField = __webpack_require__(61);
...
var Fields = (0, _FieldsRestyle2.default)({
    TextFieldUnstyled: {
    ...
    TextFieldUnstyled: _TextField2.default,
    DateFieldUnstyled: _DateField2.default,
    TextareaFieldUnstyled: _TextareaField2.default,
    NumberFieldUnstyled: _NumberField2.default,
    SubmitFieldUnstyled: _SubmitField2.default,
    SelectFieldUnstyled: _SelectField2.default,
    CheckboxFieldUnstyled: _CheckboxField2.default,
    ObjectFieldUnstyled: _ObjectField2.default,
    ListFieldUnstyled: _ListField2.default
});

var TextField = exports.TextField = Fields.TextFieldUnstyled;
var DateField = exports.DateField = Fields.DateFieldUnstyled;
var TextareaField = exports.TextareaField = Fields.TextareaFieldUnstyled;
var NumberField = exports.NumberField = Fields.NumberFieldUnstyled;
var SubmitField = exports.SubmitField = Fields.SubmitFieldUnstyled;
var SelectField = exports.SelectField = Fields.SelectFieldUnstyled;
var CheckboxField = exports.CheckboxField = Fields.CheckboxFieldUnstyled;
var ObjectField = exports.ObjectField = Fields.ObjectFieldUnstyled;
var ListField = exports.ListField = Fields.ListFieldUnstyled;
